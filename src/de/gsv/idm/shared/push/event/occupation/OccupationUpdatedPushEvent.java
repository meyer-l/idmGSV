...
public class OccupationUpdatedPushEvent extends OccupationPushEvent {
	public OccupationUpdatedPushEvent(){

	}
	public OccupationUpdatedPushEvent(OccupationDTO occupation){
		super(occupation);
	}
	@Override
